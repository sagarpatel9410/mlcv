...
plot_split_function(aa_idx_best,data,aa_dim,aa_t,aa_ig_best,1);
plot_split_function(lin_idx_best,data,lin_dim,lin_t,lin_ig_best,5);
plot_split_function(quad_idx_best,data,quad_dim,quad_t,quad_ig_best,9);
plot_split_function(cube_idx_best,data,cube_dim,cube_t,cube_ig_best,13);
