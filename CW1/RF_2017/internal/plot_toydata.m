...
hold on;
plot(data(data(:,end)==3,1), data(data(:,end)==3,2), 'o', 'MarkerSize', 15, 'MarkerFaceColor', [.5 .5 .9], 'MarkerEdgeColor','k');
elseif(strcmp(type,'test'))
plot(data(data(:,end)==1,1), data(data(:,end)==1,2), 'o', 'MarkerFaceColor', [0.8500 0.3250 0.0980], 'MarkerEdgeColor','k');
hold on;
plot(data(data(:,end)==2,1), data(data(:,end)==2,2), 'o', 'MarkerFaceColor', [0.4660 0.6740 0.1880], 'MarkerEdgeColor','k');
hold on;
plot(data(data(:,end)==3,1), data(data(:,end)==3,2), 'o', 'MarkerFaceColor', [0 0.4470 0.7410], 'MarkerEdgeColor','k');
