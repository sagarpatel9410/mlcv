...
% define number of bins for k-means clustering
numBins=256;
...
[data_train, data_test, folderName, classList, imgIdx_tr, imgIdx_te] = getData('Caltech',imgSel,rf_codebook,numBins,learner);
close all;
